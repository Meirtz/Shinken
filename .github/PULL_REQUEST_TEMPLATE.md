<!-- Keep PRs small and reviewable. Title in Conventional-Commit style, e.g. "feat(shinkend): ...". -->
...
## How it was tested
<!-- commands run, what you observed; screenshots/recordings for UI/agent behavior -->
