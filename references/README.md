...
| `cua/` | https://github.com/trycua/cua | Computer-use agent stack (cua-bench/cua-gym, in-sandbox computer-server, lume/lumier QEMU+Docker virtualization, SoM grounding). Studied for its virtualization and in-sandbox execution layering. |
