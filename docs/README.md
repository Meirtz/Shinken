...
| 10 | [Phase-0 implementation plan](10-phase0-plan.md) | The local single-Sandbox PoC: screenshot-first GUI loop, stack, milestones (M0–M4), a11y coverage spike, interface contracts, code layout | ✅ |
| 11 | [ACI specification](11-aci-spec.md) | The north-star interface: elegant API, typed actions, observation, replay, the async harness core + adapters | ✅ |
