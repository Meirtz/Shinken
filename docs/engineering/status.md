...
| **Rerunnable local benchmark suites** (10 suites + pool-fork mode: codec/delta/latency/fork/fan-out/client-scale/wire-ceiling/OSWorld-head-to-head/guest-CPU/boot-waterfall; raw JSON + figures tracked) | done | [`benchmarks/`](../../benchmarks) → [benchmarks.md](benchmarks.md) |
