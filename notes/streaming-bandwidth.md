...
Sibling docs: [../docs/design/architecture.md](../docs/design/architecture.md) (the three planes), [../docs/design/tech-decisions.md](../docs/design/tech-decisions.md) (D4/D11 as ADRs), [../docs/design/economics-and-build-vs-buy.md](../docs/design/economics-and-build-vs-buy.md) (egress cost model), [replay.md](replay.md) (the event stream as the `.skn` log), and [ai-native-interface.md](ai-native-interface.md) (D3 observation rungs that feed Tier 0).
